...
class APIClient(object):
    ...
    '''
    def __init__(self, app_key=None, app_secret=None, redirect_uri=None, response_type='code', domain='api.weibo.com', version='2'):
        #print 'test APIClient __init__ now'
        #self.client_id = str(app_key)
        self.client_id=140226478
